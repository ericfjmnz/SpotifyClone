...
function PlaylistCreator() {
    ...
    const handleCreateAiPlaylist = async () => {
        ...
        try {
            const geminiPrompt = `Based on the following theme: "${aiPrompt}", generate a list of 80 suitable songs. Include a mix of popular and less common tracks if possible.`;
